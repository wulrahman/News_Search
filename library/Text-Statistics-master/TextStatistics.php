...
class TextStatistics
{
    ...
    public function setText($strText)
    {
        ...
        if ($strText !== false) {
            self::$strText = Text1::cleanText($strText);
        }
        ...
        $score = Maths::bcCalc(
            Maths::bcCalc(
                ...
                Maths::bcCalc(
                    1.015,
                    '*',
                    Text1::averageWordsPerSentence($strText, $this->strEncoding)
                )
            ),
            '-',
            Maths::bcCalc(
        ...
        $score = Maths::bcCalc(
            Maths::bcCalc(
                Maths::bcCalc(
                    ...
                    '*',
                    Maths::bcCalc(
                        Text1::letterCount($strText, $this->strEncoding),
                        '/',
                        Text1::wordCount($strText, $this->strEncoding)
                    )
                ),
                '-',
                Maths::bcCalc(
                    ...
                    '*',
                    Maths::bcCalc(
                        Text1::sentenceCount($strText, $this->strEncoding),
                        '/',
                        Text1::wordCount($strText, $this->strEncoding)
                    )
                )
    ...
    public function daleChallDifficultWordCount($strText = false)
    {
        $strText = $this->setText($strText);
        $intDifficultWords = 0;
        $arrWords = explode(' ', Text1::lowerCase(preg_replace('`[^A-za-z\' ]`', '', $strText), $this->strEncoding));
    ...
    public function letterCount($strText = false)
    {
        ...
        return Text1::letterCount($strText, $this->strEncoding);
    }
    ...
    public function sentenceCount($strText = false)
    {
        ...
        return Text1::sentenceCount($strText, $this->strEncoding);
    }
    ...
    public function wordCount($strText = false)
    {
        ...
        return Text1::wordCount($strText, $this->strEncoding);
    }
    ...
    public function averageWordsPerSentence($strText = false)
    {
        ...
        return Text1::averageWordsPerSentence($strText, $this->strEncoding);
    }
