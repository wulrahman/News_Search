							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Training set</h2>
										<p>Here you will find assignment which are currently active, this will be used to train our automated systems.</p>
									</div>
								</div>
							</div>
                    ...
                    <div class="data-table-list">
                        ...
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                $query = mysqli_query($setting['Lid'],"SELECT SQL_CALC_FOUND_ROWS `title`,`id`, `category`, date(`timestamp`) as `date`, `sentiment`, `summary`, `hash_id` FROM `news` WHERE `training_set`='1' ORDER BY `id` DESC");
