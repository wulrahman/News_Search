...
------------------------------ */
    ...
    $("#curved-line-chart")[0] && $.plot($("#curved-line-chart"), [{
		...
		$(".stats-bar")[0] && sparklineBar("stats-bar", status_bar_data, "35px", 3, "#00c292", 2);
        $(".stats-bar-2")[0] && sparklineBar("stats-bar-2", stats_bar_2_admin, "35px", 3, "#01c0c8", 2);
        $(".stats-line")[0] && sparklineLine("stats-line", stats_line_data, 68, 35, "#fb9678", "#fb9678", 1.25, "#fb9678", "#fb9678", "#fb9678", 3, "#fb9678", "#fb9678");
        $(".stats-line-2")[0] && sparklineLine("stats-line-2", [5, 6, 3, 9, 7, 5, 4, 6, 5, 6, 4, 9], 68, 35, "#00c292", "#00c292", 1.25, "#00c292", "#00c292", "#00c292", 3, "#00c292", "#00c292");
        $(".stats-pie")[0] && sparklinePie("stats-pie", [20, 35, 30, 5], 45, 45, ["#fff", "rgba(255,255,255,0.7)", "rgba(255,255,255,0.4)", "rgba(255,255,255,0.2)"]);
        $(".dash-widget-visits")[0] && sparklineLine("dash-widget-visits", dash_widget_data, "100%", "70px", "#00c292", "#00c292", 2, "#00c292", "#00c292", "#00c292", 5, "#00c292", "#00c292");
