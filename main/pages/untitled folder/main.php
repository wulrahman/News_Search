...
if($setting['user']->model !== null) {
    ...
    $main_query = $get_content_article->get_content_user_model(3, 1);
    
}
else {
    
    $main_query = $get_content_article->get_sort_content(3, 1);
                            ...
                            <div class="section_content">
                                <div class="grid clearfix">
                                    ...
                                    if($setting['user']->model !== null) {
                                        ...
                                        $main_query = $get_content_article->get_content_user_model(array_sum($style_type), 1);
                        ...
                        <div class="blog_section">
                            ...
                            <div class="section_content">
                                <div class="grid clearfix">
                                    ...
                                    $row_content = $get_content_article->get_popular_user_preload(1, 1);
