    ...
    <header class="header" style="<?=$style?>">
        ...
        <div class="main_search_div">
            <div class="search_container">
                <form action="#">
                    <input type="search" class="header_search_input" required="required" name="q" value="<?=$q?>" placeholder="Type to Search...">
    ...
    <div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
        ...
        <div class="search">
            <form action="#">
                <input type="search" class="header_search_input menu_mm" required="required" name="q" value="<?=$q?>" placeholder="Type to Search...">
