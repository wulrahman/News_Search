...
<?php
    ...
    <script src="<?=$setting['main_url']?>/main/plugins/parallax-js-master/parallax.min.js"></script>
    <script src="<?=$setting['main_url']?>/main/js/category.js"></script>
    <script src="<?=$setting['main_url']?>/main/js/scroll_page.mjs?q=1"></script>
<?php
}
    ...
    <script src="<?=$setting['main_url']?>/main/js/scroll_page.mjs?=1"></script>
    <?php
}
?>
