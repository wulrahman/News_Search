                ...
                <div class="sidebar_slider_container">
                    <div class="owl-carousel owl-theme sidebar_slider_top">
                        ...
                        for($i=0; $i <= 2; $i++ ) {
                            ...
                            $side_main_query = $get_content_article->get_popular_user_preload(8, 1);
                            ...
                            if(count($side_main_query) > 0) {
                                ...
                                <div class="owl-item">
                                    ...
                                    foreach($side_main_query as $key => $side_main_row) {
                                        ...
                                        $title = $manipulation->limit_text(strip_tags(stripslashes(stripslashes($side_main_row["title"]))),8);

                                        $id = $side_main_row["id"];

                                        $image_main_url = $setting['main_url'].'/main/'.$side_main_row["thumb_url"]; 

                                        $author_row = $get_content_article->get_author_name($side_main_row['site']);
