...
<html>
    ...
    <head>
        ...
        <?php
        if($action == "view") { ?>
            <link rel="stylesheet" type="text/css" href="<?=$setting["main_url"]?>/main/styles/post.css">
            <link rel="stylesheet" type="text/css" href="<?=$setting["main_url"]?>/main/styles/post_responsive.css">
        <?php
        }
        else if($action == "404" || $action == 'error') { ?>
            <link rel="stylesheet" type="text/css" href="<?=$setting["main_url"]?>/main/styles/contact.css">
            <link rel="stylesheet" type="text/css" href="<?=$setting["main_url"]?>/main/styles/contact_responsive.css"><?php

        }
        else if($action == "post" || isset($_GET['q']) && !$verifier->space($_GET['q'])) { ?>
            <link rel="stylesheet" type="text/css" href="<?=$setting["main_url"]?>/main/styles/category.css">
            <link rel="stylesheet" type="text/css" href="<?=$setting["main_url"]?>/main/styles/category_responsive.css">
        <?php
        }
        else { ?>
            <link rel="stylesheet" type="text/css" href="<?=$setting["main_url"]?>/main/styles/main_styles.css?q=1">
            <link rel="stylesheet" type="text/css" href="<?=$setting["main_url"]?>/main/styles/responsive.css"><?php
        }
        ?>
