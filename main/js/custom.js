...
$(document).ready(function()
{
	...
	*/
    ...
    function update_menu_color () {
        var elem = document.querySelector(".owl-item.active div");
        var header = document.getElementsByClassName("header");
        var data_color = $(elem).attr("data-color");

        // or var elem = ul.querySelector("li div.Hello a")
        if(data_color == "black") {

            $(header['0']).attr('style', 'background-color:rgba(0,0,0,0.75)');
        ...
        console.log($(elem).attr("data-color"));
